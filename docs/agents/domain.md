...
If the concept needed is not in the glossary yet, either the project language is being invented too early or there is a real gap. Note it for `/grill-with-docs`.
