...
This file contains Copilot-specific bootstrap notes. For all pipeline behavior, creative decisions, and artifact generation, `AGENTS.md` is the canonical source of truth.

### Model-Specific Reminders
- **Artifact Contract:** Regardless of being Copilot, you must produce the same schema-valid artifact JSONs as any other model.
