...
This file contains Cursor-specific bootstrap notes. For all pipeline behavior, creative decisions, and artifact generation, `AGENTS.md` is the canonical source of truth.

### Model-Specific Reminders
- **Artifact Contract:** Regardless of being Cursor, you must produce the same schema-valid artifact JSONs as any other model.
